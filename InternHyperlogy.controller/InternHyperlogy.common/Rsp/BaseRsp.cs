...
namespace InternHyperlogy.Common.Rsp
{
    public class BaseRsp
    {
        ...
        /// <param name="message">Message</param>
        public void SetError(string code,string typeErr, string message)
        {
            TypeRes = typeErr;
            Success = false;
            Code = code;
        ...
        public string TypeRes { get => typeRes; set => typeRes = value; }
